...
//		System.out.println("gamal".substring(2));
		System.out.println(object.validateUpdateWithCondition("update a7a set(name='ganal') where (id='23')"));
		System.out.println(object.validateDelete("delete from a7a where ( id = '0' )"));
		System.out.println(object.validateDelete("delete from a7a where id='0'"));
	}
